...
hi goBlock           guifg=_babyyellow  ctermfg=Yellow
hi goBoolean         guifg=_pink
hi goDeclaration     guifg=_mtdew       ctermfg=LightGreen
hi goDeclType        guifg=_green       ctermfg=LightGreen
hi goDirective       guifg=_magenta     ctermfg=Magenta
hi goFormatSpecifier guifg=_babyyellow  ctermfg=Yellow
hi goFunction        guifg=_ltblue      ctermfg=LightBlue
hi goMethod          guifg=_ltgray
hi goOperator        guifg=_puke        ctermfg=Yellow
hi goRepeat          guifg=_babyyellow  ctermfg=Yellow
hi goStatement       guifg=_orange      ctermfg=Brown
hi goString          guifg=_firebrick   ctermfg=DarkRed
hi goStructDef       guifg=_ltblue      ctermfg=LightBlue
hi goType            guifg=_green
hi goUnsignedInts    guifg=_green
...
hi typescriptStringB guifg=_pink ctermfg=LightRed
...
hi javaParenT guifg=_birchwood ctermfg=Brown
hi javaTypedef guifg=_neongreen ctermfg=LightMagenta
hi javaType guifg=_watermelon ctermfg=LightGreen
hi javaMethodDecl guifg=_palepurple ctermfg=LightRed
hi javaString guifg=_firebrick ctermfg=DarkRed
hi javaConstant guifg=_aqua ctermfg=DarkCyan
hi javaScopeDecl guifg=_purple ctermfg=LightRed
hi javaClassDecl guifg=_mtdew ctermfg=LightGreen
hi javaAnnotation guifg=_puke ctermfg=Yellow
hi javaExternal guifg=_magenta ctermfg=DarkMagenta
...
hi yamlKey gui=NONE guifg=_puke ctermfg=Brown
hi yamlDelimiter gui=NONE guifg=_puke ctermfg=Brown
hi yamlString gui=NONE guifg=_firebrick ctermfg=DarkRed
hi yamlNumber gui=NONE guifg=_green ctermfg=Green
hi yamlComment gui=NONE guifg=_ltgray ctermfg=Grey
