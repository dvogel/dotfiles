...
namecolor name=drew_cyan rgb=#10b2c0
namecolor name=drew_aqua rgb=#0e8f9b
namecolor name=drew_blue rgb=#0e689d
namecolor name=drew_peach rgb=#e39e58
namecolor name=drew_puke rgb=#ebab6a
namecolor name=drew_skin rgb=#e3b07d
namecolor name=drew_red rgb=#cb3725
namecolor name=drew_watermelon rgb=#ee1122
namecolor name=drew_firebrick rgb=#c53534
namecolor name=drew_pink rgb=#cf2152
namecolor name=drew_palepurple rgb=#b294bb
namecolor name=drew_purple rgb=#ba99fa
namecolor name=drew_magenta rgb=#bb00bb
namecolor name=drew_green rgb=#379f4d
namecolor name=drew_neongreen rgb=#b3e46f
namecolor name=drew_khaki rgb=#ad6d2b
namecolor name=drew_brown rgb=#642e0e
namecolor name=drew_orange rgb=#e35c0f
namecolor name=drew_salmon rgb=#f37c2f
namecolor name=drew_tan rgb=#c77624
namecolor name=drew_teal rgb=#126d67
namecolor name=drew_mtdew rgb=#c6d80e
namecolor name=drew_ltblue rgb=#208ec8
namecolor name=drew_skyblue rgb=#9cd7eb
namecolor name=drew_babyyellow rgb=#fbe572
namecolor name=drew_birchwood rgb=#d9cd94
namecolor name=drew_white rgb=#dfdfdf
namecolor name=drew_grayishblue rgb=#cacaf0
namecolor name=drew_ltgray rgb=#c5c8c6
namecolor name=drew_darkgray rgb=#5e6164
namecolor name=drew_background rgb=#000000
