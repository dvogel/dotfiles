" Forked From:          https://github.com/fleiner/vim/blob/master/runtime/syntax/java.vim
...
syn keyword javaType        Integer Long Boolean String
...
syn match javaMethodCall        "[.]\zs[a-z][A-Za-z0-9_]\+\ze"

" Some development ideologies have strong opinions about import wildcards so
" this matches them specially. It will match any asterisk before the semicolon
" that ends a line with an import statement.
syn match javaImportWildcard    "\zs[*]\ze;$" contained

syn region javaImportStmt start="^import" end=";$" contains=javaExternal,javaPackageName,javaClassName,javaImportWildCard
...
" 	    \=\(\[\]\)*\s\+[a-z][A-Za-z0-9_$]*\|[A-Z][A-Za-z0-9_$]*\)\s*\ze(+ end=+\ze(+ contains=javaScopeDecl,javaType,javaStorageClass,javaComment,javaLineComment,@javaClasses,javaAnnotation
